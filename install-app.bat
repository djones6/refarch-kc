...
:: Install kc-ui
helm install kc-ui ../refarch-kc-ui/chart/kc-ui --set image.repository=ibmcase/kcontainer-ui -n shipping --wait --timeout=300s --set eventstreams.enabled=false --set serviceAccountName=kcserviceaccount
